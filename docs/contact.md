...
- **Universitas Gadjah Mada**
  ...
  - PKMK UGM (Pusat Kedokteran Masyarakat UGM)
...
- **IndoHCF** - Indonesia Healthcare Consumer Forum
- **Jaringan Rumah Sakit** - Mitra rumah sakit di seluruh Indonesia
...
- **Pemerintah**
  - **SATUSEHAT** - Platform data kesehatan nasional Kemenkes
  - **PSC 119** - Public Safety Center nasional

- **Mitra Potensial**
  - Perusahaan teknologi untuk CSR
  - Startup kesehatan digital
  - Cloud providers

## Bermitra dengan KREKI

Kami terbuka untuk kemitraan dengan:

### Universitas & Institusi Pendidikan
- Program magang untuk mahasiswa IT dan kedokteran
- Riset kolaboratif sistem kesehatan darurat
- Pengembangan kurikulum BLS/ACLS

### Perusahaan Teknologi
- CSR program untuk pengembangan sistem
- Donasi infrastruktur (server, cloud credits)
- Technical mentorship untuk relawan IT

### Institusi Kesehatan
- Integrasi sistem HELP 119 dengan rumah sakit
...
*Kembali ke [About](./index.md) | [Organization Profile](./organization.md)*
